...
import 'package:neon_rag_with_langchain/home/controller/index_notifier.dart';
import 'package:provider/provider.dart';

import '../controller/query_notifier.dart';
import '../widgets/animated_send_arrow.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<CreateandUploadState>(
        valueListenable: indexNotifierProvider.createandUploadState,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          indexNotifierProvider.createAndUploadNeonIndex();
                        },
